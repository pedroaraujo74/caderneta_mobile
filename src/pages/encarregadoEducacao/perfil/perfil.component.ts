...
form : FormGroup;
  ...
  ngOnInit() {
      ...
      this.perfil = this.http.get('https://caderneta-2b6e4.firebaseio.com/encarregados/CnSVr7jJBDfJ3PHInO2WZbcR5Ew2.json').subscribe(data => {
    ...
    editar(model: perfilEdit, isValid: boolean) {
        ...
        this.http.patch('https://caderneta-2b6e4.firebaseio.com/encarregados/CnSVr7jJBDfJ3PHInO2WZbcR5Ew2.json', model).subscribe(
          data => {
              console.log(data);
               this.ngOnInit();
          },
